...
import 'package:whatsapp_me/feature/contact/controllers/contacts_controller.dart';
import 'package:whatsapp_me/feature/contact/widget/contact_card.dart';
        ...
        data: (allContacts) {
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // print("index $index");
              // print("firebaseContacts ${allContacts[0]}");
              ...
              return index < allContacts[0].length
                  ? Column(
                      ...
                      children: [
                        ...
                        //pachhi karvu atyare kaik error aape chhe.
                        ContactCard(
