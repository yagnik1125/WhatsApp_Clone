...
class ChatRepository {
  ...
  void sendFileMessage({
    ...
    try {
      ...
      // print(receiverUserData.phoneNumber);
  ...
  Stream<List<LastMessageModel>> getAllLastMessageList() {
    return firestore
      ...
      final lastMessage = LastMessageModel.fromMap(event.docs[0].data());
      final userData =
          await firestore.collection('users').doc(lastMessage.contactId).get();
      final user = UserModel.fromMap(userData.data()!);
      contacts.add(
        LastMessageModel(
          phoneNumber: lastMessage.phoneNumber,
  ...
  void sendTextMessage({
    ...
    try {
      ...
      // print("receiverData.phoneNumber---------------->${receiverData.phoneNumber}");
