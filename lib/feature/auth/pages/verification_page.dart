...
import 'package:whatsapp_me/feature/welcome/widgets/custom_text_field.dart';
              ...
              child: RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    const TextSpan(
                      text:
                          "You've tried to register +91 8866337492. before requesting an SMS or call with your code. ",
                    ),
                    TextSpan(
                      text: 'Wrong number?',
                      style: TextStyle(
